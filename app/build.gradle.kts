...
dependencies {
    ...
    implementation(libs.findLibrary("androidx-biometric").get())
    ...
    implementation(libs.findLibrary("cardview").get())
    ...
    implementation(libs.findLibrary("play-services-fitness").get())
    ...
    implementation(libs.findLibrary("pdfbox").get())
    implementation(libs.findLibrary("opencsv").get())
